...
if response is not None:
    print(f"Port {target_port} is open, closing it now...")
    
    # Use pexpect to interact with the shell and enter the sudo password
    child = pexpect.spawn(f"sudo tcpkill host {target_ip} and port {target_port}")
    child.expect("Password:")
    child.sendline("") # This is going to be changed to a password of a red team account
